    ...
    <div className={style.UserWidget}>
      ...
      >
        ...
        <div className={style.infos}>
          <Typography ml={1} className={style.username} align={"left"} noWrap>
            {user.name.split(" ")[0]}
          </Typography>
        </div>
            ...
            <Paper>
              <ClickAwayListener onClickAway={handleClose}>
                ...
                >
                  <MenuItem
                    component="a"
                    href="https://app.peppergaming.com/nfts"
                    sx={{ display: "right", justifyContent: "flex-end" }}
                  >
                    <span style={{ fontSize: "14px" }}>Collectibles</span>
                    <GridViewRoundedIcon style={{ marginLeft: "0.6rem" }} />
                  </MenuItem>
                  <MenuItem
                  ...
                  >
                    ...
                    <LogoutOutlinedIcon style={{ marginLeft: "0.6rem" }} />
                  </MenuItem>
                </MenuList>
              </ClickAwayListener>
            </Paper>
